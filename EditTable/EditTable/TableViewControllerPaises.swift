...
class TableViewControllerPaises: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celda", for: indexPath) as? miCeldaTableViewCell

        cell?.pais.text = listaPaises[indexPath.row].pais
        cell?.capital.text = listaPaises[indexPath.row].capital
        cell?.superfiecie.text = String( listaPaises[indexPath.row].superficie)
